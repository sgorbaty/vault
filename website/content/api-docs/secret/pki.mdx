...
Within Vault Enterprise <EnterpriseAlert inline="true" />, support
can be enabled for the [EST (Enrollment over Secure Transport) protocol](https://datatracker.ietf.org/doc/html/rfc7030)
